    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          />
          <h1 className="text-xl font-semibold text-white">Sign in to KuotFlow</h1>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link href="/sign-up" className="font-medium text-blue-400 hover:text-blue-300 transition">
            Sign up
          </Link>
        </p>
      </div>
